...
const Form = ({thing, handleInput, handleSubmit}) => {
    return (
        <>
        <h1 className='text-3xl sm:text-6xl font-bold text-center'>What would you like to work on?</h1>  
        <form
        ...
        >
            ...
            />
            <button
            className='bg-inherit rounded-md font-sans text-slate-800 py-2 px-6 focus:outline-none focus:text-teal-600 hover:text-teal-600 pointer-events-none'
            >
